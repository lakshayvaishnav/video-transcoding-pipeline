...
export type GetUploadAggregateType<T extends UploadAggregateArgs> = {
    [P in keyof T & keyof AggregateUpload]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateUpload[P]> : Prisma.GetScalarType<T[P], AggregateUpload[P]>;
};
...
type GetUploadGroupByPayload<T extends UploadGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<UploadGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof UploadGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], UploadGroupByOutputType[P]> : Prisma.GetScalarType<T[P], UploadGroupByOutputType[P]>;
}>>;
export type UploadWhereInput = {
    ...
    contentType?: Prisma.StringFilter<"Upload"> | string;
    size?: Prisma.BigIntFilter<"Upload"> | bigint | number;
    ...
    jobs?: Prisma.TranscodeJobListRelationFilter;
};
export type UploadOrderByWithRelationInput = {
    ...
    jobs?: Prisma.TranscodeJobOrderByRelationAggregateInput;
};
...
export type UploadScalarWhereWithAggregatesInput = {
    ...
    contentType?: Prisma.StringWithAggregatesFilter<"Upload"> | string;
    size?: Prisma.BigIntWithAggregatesFilter<"Upload"> | bigint | number;
...
export type UploadCreateInput = {
    ...
    jobs?: Prisma.TranscodeJobCreateNestedManyWithoutUploadInput;
};
export type UploadUncheckedCreateInput = {
    ...
    createdAt?: Date | string;
    updatedAt?: Date | string;
    jobs?: Prisma.TranscodeJobUncheckedCreateNestedManyWithoutUploadInput;
};
export type UploadUpdateInput = {
    ...
    jobs?: Prisma.TranscodeJobUpdateManyWithoutUploadNestedInput;
};
export type UploadUncheckedUpdateInput = {
    ...
    createdAt?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string;
    updatedAt?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string;
    jobs?: Prisma.TranscodeJobUncheckedUpdateManyWithoutUploadNestedInput;
};
...
export type UploadCreateNestedOneWithoutJobsInput = {
    create?: Prisma.XOR<Prisma.UploadCreateWithoutJobsInput, Prisma.UploadUncheckedCreateWithoutJobsInput>;
    connectOrCreate?: Prisma.UploadCreateOrConnectWithoutJobsInput;
    connect?: Prisma.UploadWhereUniqueInput;
};
export type UploadUpdateOneRequiredWithoutJobsNestedInput = {
    create?: Prisma.XOR<Prisma.UploadCreateWithoutJobsInput, Prisma.UploadUncheckedCreateWithoutJobsInput>;
    connectOrCreate?: Prisma.UploadCreateOrConnectWithoutJobsInput;
    upsert?: Prisma.UploadUpsertWithoutJobsInput;
    connect?: Prisma.UploadWhereUniqueInput;
    update?: Prisma.XOR<Prisma.XOR<Prisma.UploadUpdateToOneWithWhereWithoutJobsInput, Prisma.UploadUpdateWithoutJobsInput>, Prisma.UploadUncheckedUpdateWithoutJobsInput>;
};
...
export type UploadUpsertWithoutJobsInput = {
    update: Prisma.XOR<Prisma.UploadUpdateWithoutJobsInput, Prisma.UploadUncheckedUpdateWithoutJobsInput>;
    create: Prisma.XOR<Prisma.UploadCreateWithoutJobsInput, Prisma.UploadUncheckedCreateWithoutJobsInput>;
    where?: Prisma.UploadWhereInput;
};
export type UploadUpdateToOneWithWhereWithoutJobsInput = {
    where?: Prisma.UploadWhereInput;
    data: Prisma.XOR<Prisma.UploadUpdateWithoutJobsInput, Prisma.UploadUncheckedUpdateWithoutJobsInput>;
};
 ...
 * UploadCountOutputType without action
 */
export type UploadCountOutputTypeCountJobsArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
...
export type UploadSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
    ...
    jobs?: boolean | Prisma.Upload$jobsArgs<ExtArgs>;
...
export type UploadOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "objectKey" | "filename" | "contentType" | "size" | "status" | "metadata" | "createdAt" | "updatedAt", ExtArgs["result"]["upload"]>;
...
export type $UploadPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    ...
    objects: {
        ...
        jobs: Prisma.$TranscodeJobPayload<ExtArgs>[];
    };
...
export type UploadCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<UploadFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface UploadDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Upload'];
        meta: {
            name: 'Upload';
        };
    };
     ...
     * })
    **/
    count<T extends UploadCountArgs>(args?: Prisma.Subset<T, UploadCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], UploadCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends UploadGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, UploadGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUploadGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface Prisma__UploadClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    jobs<T extends Prisma.Upload$jobsArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Upload$jobsArgs<ExtArgs>>): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$TranscodeJobPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>;
    /**
...
export interface UploadFieldRefs {
    ...
    readonly size: Prisma.FieldRef<"Upload", 'BigInt'>;
 ...
 * Upload.jobs
 */
export type Upload$jobsArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
